    ...
    <div class="flex flex-col w-full md:w-1/2 xl:w-2/5 2xl:w-2/5 3xl:w-1/3 mx-auto p-8 md:p-10 2xl:p-12 3xl:p-14 mt-20 rounded-2xl shadow-xl">
        ...
        <form class="flex flex-col">
            <div class="pb-2">
                ...
                <div class="relative text-gray-400"><span class="absolute inset-y-0 left-0 flex items-center p-1 pl-3"><i class="ph-bold ph-user"></i></span>
            ...
            <button type="submit" class="w-full text-[#FFFFFF] bg-black focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-6">Sign Up</button>
            <div class="text-sm font-light text-[#6B7280] ">Already have an account? <a href="#" class="font-medium text-black hover:underline">Login</a>
